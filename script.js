...
function smashed(event) {
  ...
  if (combo % 3 === 0) {
    console.log("combo!");
    score = score + 2000;
    document.querySelector(".combo").style.visibility = "visible"
    setTimeout(comboTitle, 2000)
...
function comboTitle() {
  document.querySelector(".combo").style.visibility = "hidden"
